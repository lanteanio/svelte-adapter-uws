...
export const ADAPTER_ERROR_REGISTRY = Object.freeze([
	...
	Object.freeze({
		...
		emission: 'console',
		problemPrefix: null,
		messagePrefix: '[ws] the metrics module must default-export a registry object; got ',
	...
	Object.freeze({
		...
		automaticRecovery: 'The next transition runs the handler again; a throw does not unregister it.',
