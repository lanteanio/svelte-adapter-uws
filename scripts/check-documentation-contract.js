...
export function validateReadme(readme, manifest, nativeRefs = []) {
	...
	// ordering by literal `\n` anchors, and a CRLF working copy (a clone
	// predating the LF checkout attribute) hands it CRLF - which made such a
	// tree report the block BOTH stale and out of position, two errors from one
